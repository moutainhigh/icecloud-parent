package com.icetech.common.json;
...
//        }
    ...
    private void date(Date date) {
        if (this.format == null) {
            this.format = new SimpleDateFormat(CommonConstants.DATE_TIME_FORMAT);
            this.format.setTimeZone(TimeZone.getTimeZone(CommonConstants.DATE_TIMEZONE));
        }
        add("\"");
